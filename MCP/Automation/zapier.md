...
## Why It Exists
Trigger Zapier webhooks and Zaps.

## Setup Steps
1. Navigate to the MCP settings in your Antigravity workspace.
2. Add a new server configuration for Zapier.
...
## Example Workflows
- **Workflow 1**: Automating routine tasks using Zapier tools.
- **Workflow 2**: Querying Zapier for context during agent interactions.
