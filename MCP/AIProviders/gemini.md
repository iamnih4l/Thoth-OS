...
2. Add a new server configuration for Gemini.
...
## Example Workflows
- **Workflow 1**: Automating routine tasks using Gemini tools.
- **Workflow 2**: Querying Gemini for context during agent interactions.
