...
2. Add a new server configuration for Slack.
...
## Example Workflows
- **Workflow 1**: Automating routine tasks using Slack tools.
- **Workflow 2**: Querying Slack for context during agent interactions.
