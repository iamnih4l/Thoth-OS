---
name: Debugging
description: Systematically diagnose and fix software bugs using structured debugging methodologies, from reproduction to root cause to verified fix.
---

# Debugging

## Purpose
Apply systematic debugging techniques to efficiently identify root causes and implement verified fixes.

## When to Activate
- Bug reported by users or tests
...
- Known issues with existing workarounds already applied
